...
const DOCS = [
    { title: "MCL Startup Carnival AV", category: "Corporate AV" },
    { title: "Tanny Shoes", category: "Brand Documentary" },
    { title: "Swachh Bharat", category: "Social Impact" }
];
                ...
                <div className="space-y-12">
                    {DOCS.map((doc, i) => (
                        <motion.div
                            ...
                            className="group relative w-full aspect-[21/9] rounded-3xl overflow-hidden bg-white/5 border border-white/10 hover:border-orange-500/50 transition-all duration-300 shadow-2xl flex items-center justify-center cursor-pointer"
                        >
                            ...
                            <div className="relative z-20 flex flex-col items-center justify-center">
                                ...
                                <h2 className="text-5xl font-bold tracking-tight text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-orange-400 group-hover:to-red-500 transition-colors duration-500">
                                    {doc.title}
                                </h2>
                            </div>
                        </motion.div>
