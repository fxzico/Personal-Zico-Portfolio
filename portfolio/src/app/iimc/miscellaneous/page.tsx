...
const MISC_PROJECTS = [
    ...
    { 
        title: "Institute of Life Sciences (ILS)", 
        description: "Freelance corporate videos demystifying complex scientific research for a broader audience.",
        link: "https://drive.google.com/drive/folders/1OPDtkL83IzvtOIdej_RM4R7BnKG-QrCL?usp=sharing"
    }
];
            ...
            <div className="max-w-7xl mx-auto px-8 pb-32">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {MISC_PROJECTS.map((project, i) => {
                        ...
                        const classes = "group relative h-96 rounded-3xl overflow-hidden bg-white/5 border border-white/10 hover:bg-white/[0.08] transition-all duration-300 p-8 flex flex-col items-start justify-between shadow-2xl text-left w-full";
